                     ...
                     <div class='row'>
                        <div class='col-md-12'>
                           ...
                           <ul class='menu-links'>
                              ...
                              <li>
                                 <a href='../mecanic.php'> Mécanique <i class='fa fa-angle-down fa-indicator'></i></a>
                                 <ul class='drop-down-multilevel'>
                                    <li><a href='../mecanic.php'> Services </a></li>
                                    <li><a href='../cost-estimate.php'> Devis</a></li>
                                 </ul>
                              </li>
...
$desc = $r->fetch(PDO::FETCH_ASSOC)?>

      <section class='inner-intro bg-1 bg-overlay-black-70'>
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'><?php echo $desc["brand_car"];?></h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> <?php echo $desc["brand_car"];?> </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> <?php echo $desc["seiling_price"];?></strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='mt03' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='mt03' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='<?php echo $desc["imgs"];?>'alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''><img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> <img class='img-fluid' src='<?php echo $desc["imgs"];?>' alt=''> </div>
                  </div>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'><?php echo $desc["brand_car"];?></strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'><?php echo $desc["model_car"];?></strong></li>
                           <li> <span>Boite</span> <strong class='text-right'><?php echo $desc["gearbox"];?></strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'><?php echo $desc["motor"];?></strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'><?php echo $desc["cv_car"];?></strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'><?php echo $desc["first_registration_car"];?></strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'><?php echo $desc["km"];?></strong></li>

                           <li> <span>Carburant</span> <strong class='text-right'><?php echo $desc["car_energy"];?></strong></li>

                           <li> <span>Couleur extérieure</span> <strong class='text-right'><?php echo $desc["ext_color"];?></strong></li>

                           <li> <span>Couleur intérieure</span> <strong class='text-right'><?php echo $desc["in_color"];?></strong></li>
                        </ul>
                     </div>
